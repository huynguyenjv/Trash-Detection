# 🗑️ Trash Detection System - Training Model

Comprehensive training pipeline implementation cho **2-Stage YOLOv8 Trash Detection System** theo specification trong instruction.md.

## 🎯 Overview

Hệ thống detection rác thải sử dụng **2-stage pipeline**:
1. **YOLOv8 Detection Model** → Phát hiện trash objects (bounding boxes)
2. **YOLOv8 Classification Model** → Phân loại loại rác cho từng detected object
3. **Real-time Pipeline Integration** → Kết hợp 2 models với threading optimization
