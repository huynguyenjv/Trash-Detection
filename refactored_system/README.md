# Smart Waste Management System - Refactored

Hệ thống quản lý rác thải thông minh được tái cấu trúc hoàn toàn để dễ bảo trì và mở rộng.
...
```python
from refactored_system import SmartWasteManagementSystem
...
```python
from refactored_system.core import RoutingEngine, GPSCoordinate
from refactored_system.utils import DataGenerator
...
python -c "from refactored_system.core import RoutingEngine; print('Core OK')"
python -c "from refactored_system.interfaces import WebMapInterface; print('Interfaces OK')"
python -c "from refactored_system.utils import DataGenerator; print('Utils OK')"
```
